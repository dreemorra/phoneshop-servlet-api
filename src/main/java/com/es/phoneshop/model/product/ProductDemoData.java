...
public class ProductDemoData {
    ...
    public static void saveSampleProducts() {
        ...
        //TODO: fix imageUrl
        productDao.save(new Product("sgs", "Samsung Galaxy S", new PriceHistory(new BigDecimal(200), usd, new Date(100 + 19, 12, 27)), 100, "https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/manufacturer/Samsung/Samsung%20Galaxy%20S.jpg"));
        ...
        productDao.save(new Product("sgs3", "Samsung Galaxy S III", new PriceHistory(new BigDecimal(666), usd, new Date(100 + 13, 6, 6)), 5, "https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/manufacturer/Samsung/Samsung%20Galaxy%20S%20III.jpg"));
        ...
        productDao.save(new Product("nokia3310", "Nokia 3310", new PriceHistory(new BigDecimal(400), usd, new Date(100 + 06, 6, 12)), 100, "https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/manufacturer/Nokia/Nokia%203310.jpg"));
